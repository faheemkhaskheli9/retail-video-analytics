...
1. Phase 1: Detection + tracking pipeline on sample video
2. Phase 2: Zone definition tooling and dwell-time logic
3. Phase 3: Heatmap and historical analytics storage
4. Phase 4: Dashboard for store operators
